...
(function(h) {
    ...
    function Lb(a, b, c) {
        var d, e, f = a.aoColumns, b = function(b) {
            if (b && b.time) {
                ...
                if (-1 === h.inArray(!1, i) && (i = a.iStateDuration,
    ...
    var m = function(a) {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                ...
                ib(o);
                var t = o.oClasses;
                g.bJQueryUI ? (h.extend(t, m.ext.oJUIClasses, g.oClasses),
                g.sDom === l.sDom && "lfrtip" === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'),
                o.renderer) ? h.isPlainObject(o.renderer) && !o.renderer.header && (o.renderer.header = "jqueryui") : o.renderer = "jqueryui" : h.extend(t, m.ext.classes, g.oClasses);
                q.addClass(t.sTable);
    ...
    h.extend(u.prototype, {
        ...
        iterator: function(a, b, c, d) {
            ...
            return e.length || d ? (a = new u(l,a ? e.concat.apply([], e) : e),
            b = a.selector,
            b.rows = t.rows,
            b.cols = t.cols,
            b.opts = t.opts,
