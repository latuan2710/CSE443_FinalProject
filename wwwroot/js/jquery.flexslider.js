(function ($) {
  ...
  ($.flexslider = function (el, options) {
      ...
      (methods = {
        init: function () {
          (slider.animating = !1),
            ...
            (!fade || (fade && slider.vars.smoothHeight)) &&
              ...
              msGesture
                ...
                : slider.slides.on(eventType, function (e) {
                    ...
                    slider.vars.rtl
                      ...
                      : (posFromX =
                          $slide.offset().left - $(slider).scrollLeft()),
                      posFromX <= 0 &&
        ...
        controlNav: {
            ...
            if (
              ...
              for (var i = 0; i < slider.pagingCount; i++) {
                if (
                  ...
                  slide.attr("data-thumb-alt") === void 0 &&
                  ...
                  slider.vars.controlNav === "thumbnails" &&
                    slider.vars.thumbCaptions === !0)
                ) {
                  var captn = slide.attr("data-thumbcaption");
                  if (captn !== "" && captn !== void 0) {
          ...
          update: function (action, pos) {
            slider.pagingCount > 1 && action === "add"
        ...
        touch: function () {
          ...
          if (!msGesture)
            ...
            var onMSPointerDown2 = function (e) {
              ...
              onMSGestureChange2 = function (e) {
                ...
                if (slider2) {
                  ...
                  (!scrolling || Number(new Date()) - startT > 500) &&
                    (e.preventDefault(),
                    !fade &&
                      slider2.transitions &&
                      (slider2.vars.animationLoop ||
                        (dx =
                          accDx /
                          ((slider2.currentSlide === 0 && accDx < 0) ||
                          (slider2.currentSlide === slider2.last && accDx > 0)
                ...
                if (slider2) {
                  if (
                    ...
                    var updateDx = reverse ? -dx : dx,
                      target =
                        updateDx > 0
                          ? slider2.getTarget("next")
                          : slider2.getTarget("prev");
                    slider2.canAdvance(target) &&
                    ((Number(new Date()) - startT < 550 &&
                      Math.abs(updateDx) > 50) ||
                      Math.abs(updateDx) > cwidth / 2)
                      ...
                      : fade ||
                        slider2.flexAnimate(
                          slider2.currentSlide,
                          slider2.vars.pauseOnAction,
                          !0
                        );
                  }
                  (startX = null),
            ...
            (el.style.msTouchAction = "none"),
              ...
              el.addEventListener("MSPointerDown", onMSPointerDown2, !1),
              (el._slider = slider),
              el.addEventListener("MSGestureChange", onMSGestureChange2, !1),
              el.addEventListener("MSGestureEnd", onMSGestureEnd2, !1);
          }
        },
        resize: function () {
          !slider.animating &&
        ...
        if (fade)
          ...
          type === "init" &&
            ...
            slider.vars.animationLoop &&
              ...
              type !== "init" && slider.container.find(".clone").remove(),
              slider.container
                .append(
                  methods
    ...
    ($.fn.flexslider = function (options) {
      if ((options === void 0 && (options = {}), typeof options == "object"))
        return this.each(function () {
          var $this = $(this),
            selector = options.selector ? options.selector : ".slides > li",
            $slides = $this.find(selector);
          ($slides.length === 1 && options.allowOneSlide === !1) ||
          $slides.length === 0
            ? ($slides.fadeIn(400), options.start && options.start($this))
            : $this.data("flexslider") === void 0 &&
...
//# sourceMappingURL=/cdn/shop/t/2/assets/jquery.flexslider.js.map?v=123793033804719356321666256840
