!(function () {
  (e = function () {
    ...
    window.innerShiv = (function () {
      function n(e, t, r) {
        return /^(?:area|br|col|embed|hr|img|input|link|meta|param)$/i.test(r)
          ? e
          : t + "></" + r + ">";
      }
      var s,
      ...
      return function (e, t) {
        if (
          !s &&
          (((s = o.createElement("div")).innerHTML = "<nav></nav>"),
        ...
        if (
          ((e = e
            ...
            .replace(/(<([\w:]+)[^>]*?)\/>/g, n)),
          (s.innerHTML = (r = e.match(
            /^<(tbody|tr|td|col|colgroup|thead|tfoot)/i
          ))
            ? "<table>" + e + "</table>"
            : e),
      ...
      return (
        ...
        (n.registerCallbacks = function () {
          return (
            this.$(document).bind(
              "spr:badge:loaded",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onBadgeLoad
                : void 0
            ),
            this.$(document).bind(
              "spr:product:loaded",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onProductLoad
                : void 0
            ),
            this.$(document).bind(
              "spr:reviews:loaded",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onReviewsLoad
                : void 0
            ),
            this.$(document).bind(
              "spr:form:loaded",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onFormLoad
                : void 0
            ),
            this.$(document).bind(
              "spr:form:success",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onFormSuccess
                : void 0
            ),
            this.$(document).bind(
              "spr:form:failure",
              "undefined" != typeof SPRCallbacks && null !== SPRCallbacks
                ? SPRCallbacks.onFormFailure
                : void 0
            )
          );
        }),
        (n.initRatingHandler = function () {
          return n
            .$(document)
            .on("mouseover mouseout", "form a.spr-icon-star", function (e) {
              var t, r, a;
              return (
                (t = e.currentTarget),
                ...
                "mouseover" === e.type
                  ? (r
                      .find("a.spr-icon:lt(" + a + ")")
                      .addClass("spr-icon-star-hover"),
                    r
                      .find("a.spr-icon:gt(" + (a - 1) + ")")
            ...
            this.$.each(
              ...
              function (e, t) {
                ...
                return (
                  (r = a.$(t).attr("data-id")),
                  (a.elSettings[r] = {}),
                  (a.elSettings[r].reviews_el =
                    "#" +
                    (a.$(t).attr("data-reviews-prefix")
                      ? a.$(t).attr("data-reviews-prefix")
                      : "reviews_")),
                  (a.elSettings[r].form_el =
                    "#" +
                    (a.$(t).attr("data-form-prefix")
                      ? a.$(t).attr("data-form-prefix")
                      : "form_"))
                );
              })
          ...
          return this.$.each(
            ...
            function (e, t) {
              ...
              if (
                ...
                return (
                  (a = i.$.extend(
                    { product_id: r, version: i.version },
                    i.extraAjaxParams
                  )),
                  i.$.ajax({
        ...
        (n.reportReview = function (e) {
          ...
          return (
            confirm(
              ...
              ((t = this.$.extend({ id: e }, this.extraAjaxParams)),
              this.$.get(
                this.api_url + "/reviews/report",
                t,
                this.reportCallback,
                "jsonp"
              )),
        ...
        (n.setStarRating = function (e, t) {
          return (
            t
              .find("a:lt(" + e + ")")
              .removeClass("spr-icon-star-empty spr-icon-star-hover"),
            t
              .find("a:gt(" + (e - 1) + ")")
              .removeClass("spr-icon-star-hover")
        ...
        (n.badgesCallback = function (e) {
          ...
          return (
            ...
            n.$.map(n.badgeEls, function (e) {
              var t;
              if (((t = n.$(e).attr("data-id")), r[t] !== undefined))
                return (
                  n.$(e).replaceWith(r[t]),
                  n.triggerEvent("spr:badge:loaded", { id: t })
                );
            })
          );
        }),
        (n.productCallback = function (e) {
          var t;
          return (
            (t = e.remote_id.toString()),
            n.renderProduct(t, e.product, e.aggregate_rating),
          ...
          return this.$.map(
            ...
            function (e) {
              if (t === i.$(e).attr("data-id"))
                return (
                  i.$(e).html([innerShiv(r, !1), a]),
                  i.triggerEvent("spr:product:loaded", { id: t })
                );
            })
          );
          var i;
        ...
        (n.renderForm = function (e, t) {
          return (
            this.$(this.elSettings[e].form_el + e).html(t),
            this.triggerEvent("spr:form:loaded", { id: e })
          );
        }),
        (n.renderReviews = function (e, t) {
          return (
            n.$(n.elSettings[e].reviews_el + e).html(t),
            n.triggerEvent("spr:reviews:loaded", { id: e })
          );
        }),
        (n.formCallback = function (e) {
          ...
          return (
            ...
            "success" === i &&
              (n
                .$(
                  "#shopify-product-reviews[data-id='" +
                    a +
        ...
        (n.paginateCallback = function (e) {
          var t, r;
          return (
            (r = e.remote_id.toString()), (t = e.reviews), n.renderReviews(r, t)
          );
        }),
        (n.reportCallback = function (e) {
          ...
          return (
            ...
            n
              .$(t)
              .replaceWith(
                "<span class='spr-review-reportreview'>" +
                  n.$(t).attr("data-msg") +
                  "</span>"
              )
          );
            ...
            r.readyState
              ? (r.onreadystatechange = function () {
                  if ("loaded" === r.readyState || "complete" === r.readyState)
                    return (r.onreadystatechange = null), t();
                })
              : (r.onload = function () {
                  return t();
                }),
        ...
        (n.triggerEvent = function (e, t) {
          if (
            ...
            "function" == typeof this.eventLogger)
          )
            return this.eventLogger(e);
        }),
        n
      );
    })()),
